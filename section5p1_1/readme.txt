...
The codes can run on Matlab ver.9.7 with Optimization Toolbox. In this environment, run "nonlin_eig_2d_nonlin.m" for reproducing the results presented in section 5.1.
